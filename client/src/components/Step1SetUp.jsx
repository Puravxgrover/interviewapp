...
function Step1SetUp({onStart}){
    ...
    return(
        ...
        className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-200 px-4"
        >
            <div
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <select value={mode} onChange={(e)=> setMode(e.target.value)} className="w-full py-3 px-4 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition">
