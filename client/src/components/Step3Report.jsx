...
function Step3Report({ report }) {
    ...
    if (finalScore >= 8) {
        performanceText = "Ready for job opportunitites.";
    ...
    const downloadPage = () => {
        ...
        if(finalScore >=8){
            ...
            advice =
            "Good foundation shown.Improve clarity and structure. Practice delivering concise, confident answers with stronger support examples.";
        }else{
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px sm:px-6 lg:px py-8">
                ...
                <div className="md:mb-10 w-full flex items-start gap-4 flex-wrap">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold flex-nowrap text-gray-800">
                            Interview Analytics Dashboard</h1>
                        <p className="text-gray-500 mt-2">
                            AI-powered performance insights
                        </p>
                    </div>
                </div>
                <button  onClick={ downloadPage} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap">
                    Download PDF
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                <div className="space-y-6">
                    <motion.div
                        ...
                        <p className="text-gray-400 m4t-3 text-xs sm:text-sm">
                            Out of 10
                        </p>
                        <div className="mt-4">
