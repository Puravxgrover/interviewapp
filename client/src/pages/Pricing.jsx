    ...
    const plans = [
        {
            ...
            features: [
                "250 At Interview Credits",
                "Detailed Feedback",
                "Performance Analyties",
                "Pull Interview History",
            ]
        }, {
            id: "pro",
            name: "Pro Pack",
        ...
        try{
            ...
            const options ={
                ...
                handler:async function (response){
                    ...
                    alert("Payment Succesful  Credits Added!")
                    navigate("/")
                },
                theme:{
                    color:"#10b981"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {plans.map((plan)=>{
                    ...
                    return(
                        ...
                        >
                            {/* Badge */}
                            {plan.badge && (<div className="absolute top-6 right-6 bg-emerald-600 text-white text-xs px-4 py-1 rounded-full shadow">
                                {plan.badge}
                            </div>
                            )}
                            ...
                            }} className={`w-full mt-8 py-3 rounded-xl font-semibold ttransition ${
                                isSelected ?
