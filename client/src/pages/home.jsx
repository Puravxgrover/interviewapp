...
import {
    BsRobot,
    BsMic,
    BsClock,BsBarChart,BsFileEarmarkText
} from "react-icons/bs";
...
function Home(){
    ...
    return(
        <div className="min-h-screen bg-[#f3f3f3] flex flex-col">
            ...
            <div className="flex-1 py-6 py-20">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
                         {[
                                ...
                                className={`relative. bg-white rounded-3xl border-2 border-green-100 hover:border-green-500
                                    p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition:shadow-2xl
                                    ${index===0? "rotate-[-4deg]":""}
                        ...
                        <div className="grid md:grid-cols-2 gap-10">
                            {
                                [
                                    {
                                        image: evalImg,
                                        icon: <BsBarChart size={20} />, title: "AI Answer Evaluation",
                                ...
                                [
                                    {
                                        ...
                                        desc: "Behavioural and communication based evalution."
                                    },
                                    {
                                        image: techImg,
